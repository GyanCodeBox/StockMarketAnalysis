...
const DISPLAY_MAPPINGS = {
    ...
    'Monitor': 'Early Changes Detected',
    'MONITOR': 'EARLY CHANGES',
    'Stable': 'No Immediate Structural Risk',
    'STABLE': 'STABLE REGIME',
    'Review': 'Risk/Misalignment Emerging',
    'REVIEW': 'REVIEW REQ.',
    'Critical': 'Immediate Attention Warranted',
    'CRITICAL': 'CRITICAL',
    'High Risk': 'Elevated Severity',
                                ...
                                <div className="flex items-center justify-end gap-1">
                                    ...
                                    <div className="relative group/tooltip">
                                        ...
                                        <div className="absolute top-full right-0 mt-2 w-64 p-3 bg-slate-900 border border-slate-700 text-slate-300 text-[10px] rounded shadow-xl hidden group-hover/tooltip:block z-50 normal-case font-normal leading-relaxed">
                                            Priority score reflects relative regime quality and alignment across the workspace. Not a return expectation or conviction signal.
                                        </div>
                                    </div>
                                </div>
                            </th>
